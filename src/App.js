...
function FinancialAstrology({goToHTScanner}) {
  ...
  const IPO_DB = {
    ...
    ISRG:{date:[2000,6,7],name:"Intuitive Surgical"},REGN:{date:[1991,4,4],name:"Regeneron"},
    BLK:{date:[1999,10,1],name:"BlackRock"},AXP:{date:[1977,5,2],name:"American Express"},
    C:{date:[1986,6,3],name:"Citigroup"},IBM:{date:[1915,11,11],name:"IBM"},
    QCOM:{date:[1991,12,13],name:"Qualcomm"},AVGO:{date:[2009,8,6],name:"Broadcom"},
    MU:{date:[1984,10,5],name:"Micron"},NOW:{date:[2012,6,29],name:"ServiceNow"},
    PANW:{date:[2012,7,20],name:"Palo Alto Networks"},CRWD:{date:[2019,6,12],name:"CrowdStrike"},
    // ── Batch 3: Telecom, Consumer, Finance ──────────────────────────────────
    T:{date:[1984,1,2],name:"AT&T"},VZ:{date:[1983,11,21],name:"Verizon"},
    TMUS:{date:[2007,7,2],name:"T-Mobile"},CHTR:{date:[2010,11,10],name:"Charter Comm"},
    SPOT:{date:[2018,4,3],name:"Spotify"},SNAP:{date:[2017,3,2],name:"Snap"},
    PINS:{date:[2019,4,18],name:"Pinterest"},SPGI:{date:[1966,5,2],name:"S&P Global"},
    ...
    ELV:{date:[2004,11,1],name:"Elevance Health"},AMT:{date:[1998,6,4],name:"American Tower"},
    PLD:{date:[1997,11,20],name:"Prologis"},EQIX:{date:[2000,8,16],name:"Equinix"},
    CCI:{date:[1998,8,18],name:"Crown Castle"},SPG:{date:[1993,3,19],name:"Simon Property"},
    PG:{date:[1890,1,2],name:"Procter & Gamble"},CL:{date:[1923,9,25],name:"Colgate"},
    KMB:{date:[1928,10,1],name:"Kimberly-Clark"},PM:{date:[2008,3,31],name:"Philip Morris"},
    ...
    UAL:{date:[2006,2,1],name:"United Airlines"},AAL:{date:[2013,12,9],name:"American Airlines"},
    LUV:{date:[1977,6,8],name:"Southwest Airlines"},MAR:{date:[1998,10,8],name:"Marriott"},
    HLT:{date:[2013,12,12],name:"Hilton"},FTNT:{date:[2009,11,18],name:"Fortinet"},
    // ── Batch 4: Growth & Tech ────────────────────────────────────────────────
    ACN:{date:[2001,7,19],name:"Accenture"},INTU:{date:[1993,3,12],name:"Intuit"},
    ANET:{date:[2014,6,6],name:"Arista Networks"},TTD:{date:[2016,9,21],name:"Trade Desk"},
    DASH:{date:[2020,12,9],name:"DoorDash"},APP:{date:[2018,9,18],name:"AppLovin"},
    AFRM:{date:[2021,1,13],name:"Affirm"},SMCI:{date:[2007,3,29],name:"Super Micro"},
    ARM:{date:[2023,9,14],name:"ARM Holdings"},ASML:{date:[1995,3,6],name:"ASML"},
    TSM:{date:[1994,10,13],name:"TSMC"},SHOP:{date:[2015,5,21],name:"Shopify"},
    MELI:{date:[2007,8,10],name:"MercadoLibre"},NET:{date:[2019,9,13],name:"Cloudflare"},
    HUBS:{date:[2014,10,9],name:"HubSpot"},ZM:{date:[2019,4,18],name:"Zoom"},
    DKNG:{date:[2020,4,24],name:"DraftKings"},AXON:{date:[2001,5,9],name:"Axon Enterprise"},
    BKNG:{date:[1999,3,30],name:"Booking Holdings"},EXPE:{date:[1999,11,8],name:"Expedia"},
    LULU:{date:[2007,7,27],name:"Lululemon"},RL:{date:[1997,6,12],name:"Ralph Lauren"},
    RCL:{date:[1993,4,10],name:"Royal Caribbean"},CCL:{date:[1987,7,31],name:"Carnival"},
    NCLH:{date:[2013,1,18],name:"Norwegian Cruise"},MGM:{date:[2011,2,10],name:"MGM Resorts"},
    WYNN:{date:[2002,10,25],name:"Wynn Resorts"},LVS:{date:[2004,12,14],name:"Las Vegas Sands"},
    // ── Batch 5: Healthcare & Biotech ─────────────────────────────────────────
    GILD:{date:[1992,1,22],name:"Gilead Sciences"},BIIB:{date:[1991,3,6],name:"Biogen"},
    VRTX:{date:[1991,7,26],name:"Vertex Pharma"},IDXX:{date:[1991,6,12],name:"IDEXX Labs"},
    ...
    BSX:{date:[1992,5,18],name:"Boston Scientific"},SYK:{date:[1979,9,1],name:"Stryker"},
    ZTS:{date:[2013,2,1],name:"Zoetis"},IQV:{date:[2014,5,9],name:"IQVIA"},
    WAT:{date:[1994,11,18],name:"Waters Corp"},A:{date:[1999,11,18],name:"Agilent Tech"},
    COO:{date:[1997,5,1],name:"Cooper Companies"},TECH:{date:[1997,12,3],name:"Bio-Techne"},
    DGX:{date:[1996,12,19],name:"Quest Diagnostics"},LH:{date:[1971,9,1],name:"Labcorp"},
    MRNA:{date:[2018,12,6],name:"Moderna"},BMY:{date:[1929,7,1],name:"Bristol Myers"},
    MRK:{date:[1946,6,1],name:"Merck"},AMGN:{date:[1983,6,17],name:"Amgen"},
    ABT:{date:[1929,11,1],name:"Abbott Labs"},GEHC:{date:[2023,1,4],name:"GE HealthCare"},
    MOH:{date:[2003,12,18],name:"Molina Healthcare"},UHS:{date:[1981,10,1],name:"Universal Health"},
    HCA:{date:[1992,3,4],name:"HCA Healthcare"},CRL:{date:[2000,6,27],name:"Charles River Labs"},
    // ── Batch 6: Financials & Insurance ──────────────────────────────────────
    SCHW:{date:[1987,9,22],name:"Charles Schwab"},MS:{date:[1986,3,21],name:"Morgan Stanley"},
    WFC:{date:[1970,1,2],name:"Wells Fargo"},BAC:{date:[1972,1,3],name:"Bank of America"},
    V:{date:[2008,3,19],name:"Visa"},MA:{date:[2006,5,25],name:"Mastercard"},
    PYPL:{date:[2015,7,20],name:"PayPal"},COF:{date:[1994,11,16],name:"Capital One"},
    ...
    AON:{date:[1982,9,1],name:"Aon"},MMC:{date:[1962,3,1],name:"Marsh McLennan"},
    AIG:{date:[1969,5,1],name:"AIG"},PRU:{date:[2001,12,13],name:"Prudential"},
    AFL:{date:[1974,2,5],name:"Aflac"},ALL:{date:[1993,6,2],name:"Allstate"},
    MET:{date:[2000,4,5],name:"MetLife"},HIG:{date:[1995,3,23],name:"Hartford Financial"},
    PGR:{date:[1965,4,15],name:"Progressive"},STT:{date:[1967,3,1],name:"State Street"},
    ...
    KEY:{date:[1972,3,1],name:"KeyCorp"},FITB:{date:[1975,4,1],name:"Fifth Third"},
    HBAN:{date:[1983,11,1],name:"Huntington"},MTB:{date:[1983,4,1],name:"M&T Bank"},
    RF:{date:[1971,8,1],name:"Regions Financial"},CFG:{date:[2014,9,24],name:"Citizens Financial"},
    MSCI:{date:[2007,11,15],name:"MSCI"},VRSK:{date:[2009,10,7],name:"Verisk"},
    // ── Batch 7: Energy & Utilities ───────────────────────────────────────────
    ...
    BKR:{date:[2017,7,3],name:"Baker Hughes"},SLB:{date:[1962,11,15],name:"SLB"},
    DVN:{date:[1988,9,1],name:"Devon Energy"},FANG:{date:[2012,10,11],name:"Diamondback Energy"},
    MPC:{date:[2011,6,23],name:"Marathon Petroleum"},VLO:{date:[1981,10,1],name:"Valero"},
    PSX:{date:[2012,4,30],name:"Phillips 66"},HES:{date:[1969,1,2],name:"Hess Corp"},
    ...
    EXC:{date:[1994,1,3],name:"Exelon"},D:{date:[1983,11,1],name:"Dominion Energy"},
    SRE:{date:[1998,6,26],name:"Sempra"},ED:{date:[1936,5,1],name:"Con Edison"},
    WEC:{date:[1947,1,2],name:"WEC Energy"},XEL:{date:[1947,1,2],name:"Xcel Energy"},
    DTE:{date:[1947,1,2],name:"DTE Energy"},PPL:{date:[1946,3,1],name:"PPL Corp"},
    CMS:{date:[1987,3,1],name:"CMS Energy"},ETR:{date:[1968,1,2],name:"Entergy"},
    EIX:{date:[1909,1,2],name:"Edison Intl"},NRG:{date:[2003,12,5],name:"NRG Energy"},
    PCG:{date:[1912,10,1],name:"PG&E"},AES:{date:[1991,6,12],name:"AES Corp"},
    CEG:{date:[2022,2,2],name:"Constellation Energy"},ENPH:{date:[2012,3,30],name:"Enphase"},
    OKE:{date:[1997,5,1],name:"ONEOK"},WMB:{date:[1975,3,1],name:"Williams Companies"},
    KMI:{date:[2012,2,10],name:"Kinder Morgan"},
    // ── Batch 8: Materials & Industrials ─────────────────────────────────────
    ...
    MOS:{date:[2004,10,22],name:"Mosaic"},CF:{date:[2005,8,10],name:"CF Industries"},
    ...
    CARR:{date:[2020,4,3],name:"Carrier Global"},OTIS:{date:[2020,4,3],name:"Otis"},
    TT:{date:[1925,1,2],name:"Trane Tech"},JCI:{date:[1978,5,1],name:"Johnson Controls"},
    AME:{date:[1930,1,2],name:"AMETEK"},PWR:{date:[2001,2,6],name:"Quanta Services"},
    XYL:{date:[2011,10,31],name:"Xylem"},DOV:{date:[1955,3,1],name:"Dover Corp"},
    IR:{date:[2020,3,2],name:"Ingersoll Rand"},GD:{date:[1952,4,1],name:"General Dynamics"},
    NOC:{date:[1994,4,18],name:"Northrop Grumman"},LHX:{date:[2019,3,1],name:"L3Harris"},
    HII:{date:[2011,3,31],name:"Huntington Ingalls"},TDG:{date:[2006,3,16],name:"TransDigm"},
    PCAR:{date:[1955,3,1],name:"PACCAR"},CMI:{date:[1952,2,1],name:"Cummins"},
    // ── Batch 9: Consumer Staples & Discretionary ────────────────────────────
    WMT:{date:[1972,8,25],name:"Walmart"},TGT:{date:[1967,2,8],name:"Target"},
    COST:{date:[1985,12,5],name:"Costco"},KR:{date:[1928,3,1],name:"Kroger"},
    KO:{date:[1919,9,5],name:"Coca-Cola"},PEP:{date:[1972,6,1],name:"PepsiCo"},
    GIS:{date:[1928,7,2],name:"General Mills"},KHC:{date:[2015,7,6],name:"Kraft Heinz"},
    MDLZ:{date:[2012,10,1],name:"Mondelez"},HSY:{date:[1927,9,1],name:"Hershey"},
    ...
    CLX:{date:[1969,5,1],name:"Clorox"},CHD:{date:[1981,1,2],name:"Church & Dwight"},
    PG:{date:[1890,1,2],name:"Procter & Gamble"},CL:{date:[1923,9,25],name:"Colgate"},
    AZO:{date:[1991,11,18],name:"AutoZone"},ORLY:{date:[1993,4,22],name:"O'Reilly Auto"},
    TSCO:{date:[1994,2,1],name:"Tractor Supply"},DLTR:{date:[1995,3,6],name:"Dollar Tree"},
    DG:{date:[2009,11,13],name:"Dollar General"},KMX:{date:[2002,2,1],name:"CarMax"},
    BBY:{date:[1985,5,20],name:"Best Buy"},WSM:{date:[1983,4,1],name:"Williams-Sonoma"},
    EBAY:{date:[1998,9,24],name:"eBay"},ROST:{date:[1985,8,23],name:"Ross Stores"},
    TPR:{date:[2000,10,11],name:"Tapestry"},RL:{date:[1997,6,12],name:"Ralph Lauren"},
    DECK:{date:[1993,10,14],name:"Deckers"},VFC:{date:[1966,11,1],name:"VF Corp"},
    NKE:{date:[1980,12,2],name:"Nike"},LULU:{date:[2007,7,27],name:"Lululemon"},
    SBUX:{date:[1992,6,26],name:"Starbucks"},MCD:{date:[1966,4,21],name:"McDonald's"},
    CMG:{date:[2006,1,26],name:"Chipotle"},DPZ:{date:[2004,7,13],name:"Domino's"},
    YUM:{date:[1997,10,7],name:"Yum Brands"},QSR:{date:[2014,12,12],name:"Restaurant Brands"},
    WING:{date:[2015,10,29],name:"Wingstop"},SHAK:{date:[2015,1,30],name:"Shake Shack"},
    BROS:{date:[2021,9,29],name:"Dutch Bros"},
    // ── Batch 10: Semis, Software, More Tech ─────────────────────────────────
    TXN:{date:[1953,10,1],name:"Texas Instruments"},AMAT:{date:[1972,10,5],name:"Applied Materials"},
    LRCX:{date:[1984,5,7],name:"Lam Research"},ADSK:{date:[1985,6,21],name:"Autodesk"},
    CDNS:{date:[1988,5,2],name:"Cadence Design"},SNPS:{date:[1992,2,26],name:"Synopsys"},
    NXPI:{date:[2010,8,6],name:"NXP Semis"},ON:{date:[2000,5,10],name:"ON Semiconductor"},
    MCHP:{date:[1993,3,23],name:"Microchip Technology"},MPWR:{date:[2004,11,4],name:"Monolithic Power"},
    OKTA:{date:[2017,4,7],name:"Okta"},DDOG:{date:[2019,9,19],name:"Datadog"},
    ZS:{date:[2018,3,16],name:"Zscaler"},FTNT:{date:[2009,11,18],name:"Fortinet"},
    RBLX:{date:[2021,3,10],name:"Roblox"},SE:{date:[2017,10,20],name:"Sea Limited"},
    ...
    GTLB:{date:[2021,10,14],name:"GitLab"},PDD:{date:[2018,7,26],name:"PDD Holdings"},
    JD:{date:[2014,5,22],name:"JD.com"},BIDU:{date:[2005,8,5],name:"Baidu"},
    BABA:{date:[2014,9,19],name:"Alibaba"},
    // ── Batch 11: REITs, Transport, Services ─────────────────────────────────
    PSA:{date:[1984,10,1],name:"Public Storage"},EQR:{date:[1993,8,18],name:"Equity Residential"},
    AVB:{date:[1994,3,11],name:"AvalonBay"},WELL:{date:[1992,5,1],name:"Welltower"},
    VTR:{date:[1999,2,1],name:"Ventas"},ARE:{date:[1994,5,26],name:"Alexandria RE"},
    MAA:{date:[1994,2,4],name:"Mid-America Apt"},CPT:{date:[1993,3,19],name:"Camden Property"},
    UDR:{date:[1972,8,1],name:"UDR Inc"},INVH:{date:[2017,2,1],name:"Invitation Homes"},
    EXR:{date:[2004,8,17],name:"Extra Space Storage"},IRM:{date:[1996,2,7],name:"Iron Mountain"},
    SBAC:{date:[1999,6,16],name:"SBA Communications"},DLR:{date:[2004,11,3],name:"Digital Realty"},
    HST:{date:[1998,1,12],name:"Host Hotels"},REG:{date:[1963,6,1],name:"Regency Centers"},
    FRT:{date:[1962,11,1],name:"Federal Realty"},KIM:{date:[1991,11,1],name:"Kimco Realty"},
    VNO:{date:[1993,8,1],name:"Vornado"},O:{date:[1994,10,18],name:"Realty Income"},
    UNP:{date:[1969,3,1],name:"Union Pacific"},NSC:{date:[1982,6,1],name:"Norfolk Southern"},
    CSX:{date:[1980,5,1],name:"CSX Corp"},WAB:{date:[1995,4,19],name:"Westinghouse Air Brake"},
    UPS:{date:[1999,11,10],name:"UPS"},FDX:{date:[1978,4,12],name:"FedEx"},
    ODFL:{date:[1991,9,19],name:"Old Dominion"},EXPD:{date:[1984,7,1],name:"Expeditors Intl"},
    CHRW:{date:[1997,10,8],name:"CH Robinson"},WM:{date:[1971,6,1],name:"Waste Mgmt"},
    RSG:{date:[1998,12,14],name:"Republic Services"},MCK:{date:[1994,10,24],name:"McKesson"},
    CAH:{date:[1983,8,1],name:"Cardinal Health"},CTAS:{date:[1983,6,21],name:"Cintas"},
    PAYX:{date:[1983,7,1],name:"Paychex"},PAYC:{date:[2014,4,15],name:"Paycom"},
    ADP:{date:[1961,9,1],name:"ADP"},FAST:{date:[1987,8,21],name:"Fastenal"},
    GWW:{date:[1967,4,1],name:"WW Grainger"},URI:{date:[1997,12,12],name:"United Rentals"},
    // ── Batch 12: Remaining S&P 500 ──────────────────────────────────────────
    MSCI:{date:[2007,11,15],name:"MSCI"},VRSK:{date:[2009,10,7],name:"Verisk"},
    EFX:{date:[1965,3,1],name:"Equifax"},FICO:{date:[1987,6,1],name:"FICO"},
    IVZ:{date:[2000,2,3],name:"Invesco"},BX:{date:[2007,6,22],name:"Blackstone"},
    KKR:{date:[2010,7,15],name:"KKR"},APO:{date:[2011,3,29],name:"Apollo Global"},
    TROW:{date:[1986,4,8],name:"T Rowe Price"},GPC:{date:[1928,3,1],name:"Genuine Parts"},
    SYY:{date:[1970,8,1],name:"Sysco"},TAP:{date:[1993,8,1],name:"Molson Coors"},
    STZ:{date:[1972,11,1],name:"Constellation Brands"},MNST:{date:[1995,6,14],name:"Monster Beverage"},
    CINF:{date:[1957,8,1],name:"Cincinnati Financial"},WRB:{date:[1974,8,1],name:"WR Berkley"},
    RHI:{date:[1978,9,1],name:"Robert Half"},RJF:{date:[1983,3,1],name:"Raymond James"},
    ROL:{date:[1967,6,1],name:"Rollins"},NI:{date:[1912,1,2],name:"NiSource"},
    NTAP:{date:[1995,11,21],name:"NetApp"},NTRS:{date:[1971,8,1],name:"Northern Trust"},
    NVR:{date:[1993,4,9],name:"NVR Inc"},OMC:{date:[1986,5,1],name:"Omnicom Group"},
    PEG:{date:[1947,4,1],name:"PSEG"},PFG:{date:[2001,10,22],name:"Principal Financial"},
    PKG:{date:[2000,1,28],name:"Packaging Corp"},PNW:{date:[1947,1,2],name:"Pinnacle West"},
    POOL:{date:[1995,10,31],name:"Pool Corp"},PTC:{date:[1989,5,26],name:"PTC Inc"},
    QRVO:{date:[2015,1,2],name:"Qorvo"},LEN:{date:[1971,1,1],name:"Lennar"},
    DHI:{date:[1992,6,12],name:"DR Horton"},PHM:{date:[1972,3,1],name:"PulteGroup"},
    NVR:{date:[1993,4,9],name:"NVR Inc"},TOL:{date:[1986,5,12],name:"Toll Brothers"},
    SNA:{date:[1930,6,1],name:"Snap-on"},SWK:{date:[1966,11,1],name:"Stanley Black & Decker"},
    TDY:{date:[1999,11,19],name:"Teledyne"},TEL:{date:[2007,6,29],name:"TE Connectivity"},
    TER:{date:[1978,10,1],name:"Teradyne"},TFX:{date:[1996,2,14],name:"Teleflex"},
    TRMB:{date:[1990,9,1],name:"Trimble"},TSN:{date:[1963,6,1],name:"Tyson Foods"},
    TTWO:{date:[1993,4,15],name:"Take-Two Interactive"},TXT:{date:[1966,4,1],name:"Textron"},
    TYL:{date:[1997,6,12],name:"Tyler Technologies"},VLTO:{date:[2023,9,29],name:"Veralto"},
    VTRS:{date:[2020,11,16],name:"Viatris"},WAT:{date:[1994,11,18],name:"Waters Corp"},
    ...
    ZBRA:{date:[1991,11,8],name:"Zebra Technologies"},ZTS:{date:[2013,2,1],name:"Zoetis"},
    BIIB:{date:[1991,3,6],name:"Biogen"},GILD:{date:[1992,1,22],name:"Gilead"},
    HAS:{date:[1968,8,1],name:"Hasbro"},PEAK:{date:[1985,5,1],name:"Healthpeak"},
    HSIC:{date:[1995,11,3],name:"Henry Schein"},STE:{date:[1992,11,3],name:"Steris"},
    BWA:{date:[1993,4,8],name:"BorgWarner"},LKQ:{date:[2003,10,3],name:"LKQ Corp"},
    MAS:{date:[1955,1,2],name:"Masco Corp"},AIZ:{date:[2003,2,5],name:"Assurant"},
    ALLE:{date:[2013,11,18],name:"Allegion"},AKAM:{date:[1999,10,29],name:"Akamai"},
    CTSH:{date:[1998,6,19],name:"Cognizant"},BR:{date:[2007,3,30],name:"Broadridge Financial"},
    CPRT:{date:[1994,2,22],name:"Copart"},GLW:{date:[1945,5,1],name:"Corning"},
    CTVA:{date:[2019,6,3],name:"Corteva"},DD:{date:[2019,6,3],name:"DuPont"},
    DOW:{date:[2019,4,2],name:"Dow Inc"},CE:{date:[2005,1,26],name:"Celanese"},
    LYB:{date:[2010,10,14],name:"LyondellBasell"},EMN:{date:[1994,1,3],name:"Eastman Chemical"},
    AVY:{date:[1961,9,1],name:"Avery Dennison"},BALL:{date:[1972,11,1],name:"Ball Corp"},
    BG:{date:[2001,8,1],name:"Bunge Global"},BLDR:{date:[2004,7,22],name:"Builders FirstSource"},
    CBRE:{date:[2004,6,10],name:"CBRE Group"},CDW:{date:[2013,7,2],name:"CDW Corp"},
    CNC:{date:[2001,1,3],name:"Centene"},CNP:{date:[1930,6,1],name:"CenterPoint Energy"},
    CMA:{date:[1973,1,2],name:"Comerica"},CPB:{date:[1954,6,1],name:"Campbell Soup"},
    CZR:{date:[2004,1,28],name:"Caesars Entertainment"},DRI:{date:[1995,5,10],name:"Darden Restaurants"},
    DVA:{date:[1995,11,1],name:"DaVita"},DFS:{date:[2007,6,12],name:"Discover Financial"},
    ES:{date:[1947,4,1],name:"Eversource Energy"},FDS:{date:[1996,7,31],name:"FactSet Research"},
    FFIV:{date:[1999,6,4],name:"F5 Inc"},HWM:{date:[2016,11,1],name:"Howmet Aerospace"},
    IEX:{date:[2001,3,15],name:"IDEX Corp"},IFF:{date:[1951,9,1],name:"Intl Flavors"},
    IP:{date:[1936,1,2],name:"Intl Paper"},IPG:{date:[1969,5,1],name:"Interpublic Group"},
    L:{date:[1956,4,1],name:"Loews Corp"},LYV:{date:[2005,2,14],name:"Live Nation"},
    MHK:{date:[1992,4,1],name:"Mohawk Industries"},MOS:{date:[2004,10,22],name:"Mosaic"},
    MSI:{date:[1969,9,1],name:"Motorola Solutions"},NWS:{date:[2013,6,19],name:"News Corp"},
    NTES:{date:[2000,6,30],name:"NetEase"},TME:{date:[2019,3,12],name:"Tencent Music"},
    PENN:{date:[1994,3,14],name:"Penn Entertainment"},SIX:{date:[1998,4,1],name:"Six Flags"},
    H:{date:[2009,11,5],name:"Hyatt Hotels"},CZR:{date:[2004,1,28],name:"Caesars"},
    LYFT:{date:[2019,3,29],name:"Lyft"},TLT:{date:[2002,7,26],name:"20yr Treasury ETF"},
    HYG:{date:[2007,4,11],name:"High Yield Bond ETF"},GLD:{date:[2004,11,18],name:"Gold ETF"},
    IWM:{date:[2000,5,22],name:"Russell 2000"},QQQ:{date:[1999,3,10],name:"Nasdaq ETF"},
    SPY:{date:[1993,1,22],name:"S&P 500 ETF"},
  };
...
// ─── HUMAN ENERGY READER ──────────────────────────────────────────────────────
function HumanEnergyReader() {
  const [name, setName] = useState("");
  const [dob, setDob] = useState("");
  const [analysisDate, setAnalysisDate] = useState(new Date().toISOString().split("T")[0]);
  const [result, setResult] = useState(null);
  const [saved, setSaved] = useState(() => {
    try { return JSON.parse(localStorage.getItem("bondo_people") || "[]"); } catch { return []; }
  });
  const [showTimeline, setShowTimeline] = useState(false);
  const [timelineData, setTimelineData] = useState([]);

  // ── Astronomy (same engine as Financial Astrology) ────────────────────────
  ...
  const ASPECTS=[[0,8,"Conjunction","intense"],[60,6,"Sextile","positive"],[90,7,"Square","tense"],[120,8,"Trine","positive"],[150,5,"Quincunx","mixed"],[180,8,"Opposition","tense"]];
  const PW={sun:9,moon:8,mercury:6,venus:7,mars:7,jupiter:9,saturn:8,uranus:5,neptune:4,pluto:5};

  // Planet meanings for humans
  const PLANET_MEANING = {
    sun:"Vitality & Identity",moon:"Emotions & Intuition",mercury:"Mind & Communication",
    venus:"Love & Harmony",mars:"Drive & Energy",jupiter:"Luck & Expansion",
    saturn:"Discipline & Karma",uranus:"Change & Disruption",neptune:"Spirituality & Dreams",pluto:"Transformation"
  };

  const ASPECT_MEANING = {
    "Conjunction":"Amplified energy — intense focus in this area",
    "Sextile":"Opportunities flowing — favorable, take action",
    "Square":"Tension & challenge — growth through friction",
    "Trine":"Natural flow — gifts and easy energy",
    "Quincunx":"Adjustment needed — subtle friction",
    "Opposition":"Balance required — pulling in two directions"
  };

  const calcHumanEnergy = (birthDate, transitDateStr) => {
    const[by,bm,bd]=birthDate.split("-").map(Number);
    const[ty,tm,td]=transitDateStr.split("-").map(Number);
    const natal=getAll(by,bm,bd);
    const transit=getAll(ty,tm,td);
      ...
      for(const[nP,nDeg]of Object.entries(natal)){
        ...
        for(const[aspAngle,orb,aspName,nature]of ASPECTS){
          if(Math.abs(angle-aspAngle)<=orb){
            const exactness=1-Math.abs(angle-aspAngle)/orb;
            const baseScore=nature==="positive"?1:nature==="tense"?-1:0.2;
            const score=baseScore*((PW[tP]+PW[nP])/16)*exactness;
            totalScore+=score;
            if(exactness>0.35){
              aspects.push({transit:tP,natal:nP,aspect:aspName,nature,score,exactness,tDeg,nDeg,tSign:signName(tDeg),nSign:signName(nDeg)});
            }
    ...
    // Energy domains
    const domains = {
      wealth: 0, health: 0, love: 0, focus: 0, luck: 0
    };
    aspects.forEach(a => {
      const s = a.score;
      if(["jupiter","venus","sun"].includes(a.natal)||["jupiter","venus","sun"].includes(a.transit)) domains.luck += s;
      if(["saturn","mars"].includes(a.natal)||["saturn","mars"].includes(a.transit)) domains.focus += s * 0.7;
      if(["moon","venus"].includes(a.natal)||["moon","venus"].includes(a.transit)) domains.love += s;
      if(["sun","mars","jupiter"].includes(a.natal)||["sun","mars","jupiter"].includes(a.transit)) domains.wealth += s;
      if(["moon","sun","mercury"].includes(a.natal)||["moon","sun","mercury"].includes(a.transit)) domains.health += s;
    });

    // Normalize domains -10 to +10
    Object.keys(domains).forEach(k => {
      domains[k] = Math.max(-10, Math.min(10, domains[k] * 2));
    });

    // Overall verdict
    const verdict = normalized>=5?"PEAK ENERGY 🔥":normalized>=3?"HIGH ENERGY ✨":normalized>=1?"POSITIVE ENERGY 🟢":normalized>=-1?"BALANCED ⚖️":normalized>=-3?"LOW ENERGY 🟡":normalized>=-5?"CHALLENGING 🔴":"DIFFICULT PERIOD ⛔";
    const verdictColor = normalized>=3?"#00e676":normalized>=1?"#38bdf8":normalized>=-1?"#f59e0b":normalized>=-3?"#ff9800":"#ff5252";

    // Sun sign (natal)
    const sunSign = signName(natal.sun);
    const moonSign = signName(natal.moon);
    const mercurySign = signName(natal.mercury);

    // Moon phase
    const jd=julianDay(ty,tm,td),phase=((((jd-2451550.1)/29.530588)%1)+1)%1;
    ...
    // Trading advice based on energy
    let tradingAdvice = "";
    if(normalized>=3) tradingAdvice="🔥 Energy is HIGH — good day to take confident trades. Trust your instincts.";
    else if(normalized>=1) tradingAdvice="✨ Positive energy — trade normally, follow your system.";
    else if(normalized>=-1) tradingAdvice="⚖️ Balanced energy — be selective, wait for clear signals.";
    else if(normalized>=-3) tradingAdvice="🟡 Lower energy — trade smaller size, avoid overtrading.";
    else tradingAdvice="🔴 Challenging energy — consider sitting out or trading minimal size today.";

    return {score:normalized,verdict,verdictColor,aspects:aspects.slice(0,10),natal,transit,domains,sunSign,moonSign,mercurySign,moonPhase,tradingAdvice};
  };

  const analyze = () => {
    if(!dob) return;
    const r = calcHumanEnergy(dob, analysisDate);
    setResult({...r, name: name||"Anonymous", dob, analysisDate});
  };

  const savePerson = () => {
    if(!dob) return;
    const person = {name: name||"Anonymous", dob, id: Date.now()};
    const updated = [...saved.filter(p=>p.dob!==dob), person];
    setSaved(updated);
    try { localStorage.setItem("bondo_people", JSON.stringify(updated)); } catch{}
  };
  ...
  const generateTimeline = (birthDate) => {
    const base = new Date(analysisDate);
    const points = [];
    for(let i=-90;i<=90;i+=3){
      const d=new Date(base);d.setDate(d.getDate()+i);
      const str=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}-${String(d.getDate()).padStart(2,"0")}`;
      const r=calcHumanEnergy(birthDate, str);
      points.push({date:str,score:r.score,isToday:i===0,isFuture:i>0});
    }
  ...
  const renderTimeline = () => {
    ...
    let path="";
    timelineData.forEach((d,i)=>{const x=toX(i),y=toY(d.score);if(i===0)path=`M${x},${y}`;else path+=` L${x},${y}`;});
    const peaks=[...timelineData].sort((a,b)=>b.score-a.score).slice(0,3);
    const troughs=[...timelineData].sort((a,b)=>a.score-b.score).slice(0,3);
    return(
      <div style={{background:"#080e1a",border:"1px solid #1e3a5a",borderRadius:8,padding:12,marginTop:12}}>
        <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}>
          <div style={{fontSize:9,color:"#3a6e9a",letterSpacing:"0.1em"}}>ENERGY TIMELINE ±90 DAYS</div>
        ...
        <svg viewBox={`0 0 ${W} ${H}`} style={{width:"100%",height:"auto"}}>
          ...
          <text x={PAD} y={H-4} fill="#3a6e9a" fontSize="8">-90d</text>
          <text x={W/2-8} y={H-4} fill="#f59e0b" fontSize="8">TODAY</text>
          <text x={W-PAD-8} y={H-4} fill="#3a6e9a" fontSize="8">+90d</text>
        </svg>
        <div style={{display:"flex",gap:6,flexWrap:"wrap",marginTop:6}}>
          {peaks.map((d,i)=><div key={i} style={{background:"#00e67611",border:"1px solid #00e67633",borderRadius:4,padding:"3px 8px",fontSize:10}}><span style={{color:"#00e676",fontWeight:700}}>▲{d.score.toFixed(1)}</span><span style={{color:"#3a6e9a",marginLeft:4}}>{d.date}</span>{d.isFuture&&<span style={{color:"#38bdf8",marginLeft:4,fontSize:9}}>FUTURE</span>}</div>)}
          {troughs.map((d,i)=><div key={i} style={{background:"#ff525211",border:"1px solid #ff525233",borderRadius:4,padding:"3px 8px",fontSize:10}}><span style={{color:"#ff5252",fontWeight:700}}>▼{d.score.toFixed(1)}</span><span style={{color:"#3a6e9a",marginLeft:4}}>{d.date}</span>{d.isFuture&&<span style={{color:"#38bdf8",marginLeft:4,fontSize:9}}>FUTURE</span>}</div>)}
        </div>
      </div>
    );
  };

  const domainBar = (label, value, color) => {
    const pct = ((value+10)/20)*100;
    return(
      <div style={{marginBottom:8}}>
        <div style={{display:"flex",justifyContent:"space-between",marginBottom:3}}>
          <span style={{fontSize:10,color:"#3a6e9a"}}>{label}</span>
          <span style={{fontSize:10,fontWeight:700,color}}>{value>=0?"+":""}{value.toFixed(1)}</span>
        </div>
        <div style={{height:5,background:"#1e3a5a",borderRadius:3,position:"relative"}}>
          <div style={{position:"absolute",left:"50%",top:0,width:1,height:"100%",background:"#2a5a7a"}}/>
  ...
  return(
    <div style={{flex:1,overflowY:"auto",background:"#080e1a",color:"#e8f4ff",fontFamily:"monospace",padding:"12px 10px"}}>
      <div style={{maxWidth:800,margin:"0 auto"}}>
        ...
        <div style={{marginBottom:14}}>
          <div style={{fontSize:10,color:"#3a6e9a",letterSpacing:"0.1em"}}>ATM MACHINE v6.0</div>
          <div style={{fontSize:16,fontWeight:700}}>🧬 Human Energy Reader</div>
          <div style={{fontSize:10,color:"#3a6e9a"}}>Enter date of birth → see planetary energy for any date</div>
        </div>

        {/* Input form */}
        <div style={{background:"#0d1e30",border:"1px solid #1e3a5a",borderRadius:8,padding:"14px",marginBottom:14}}>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10}}>
            <div>
              <div style={{fontSize:9,color:"#3a6e9a",marginBottom:4}}>NAME (optional)</div>
              <input value={name} onChange={e=>setName(e.target.value)} placeholder="e.g. Alo, Jensen Huang..."
                style={{width:"100%",background:"#080e1a",border:"1px solid #1e3a5a",borderRadius:4,color:"#e8f4ff",padding:"8px 10px",fontSize:12,fontFamily:"monospace",boxSizing:"border-box"}}/>
            </div>
            <div>
              <div style={{fontSize:9,color:"#3a6e9a",marginBottom:4}}>DATE OF BIRTH</div>
              <input type="date" value={dob} onChange={e=>setDob(e.target.value)}
                style={{width:"100%",background:"#080e1a",border:"1px solid #1e3a5a",borderRadius:4,color:"#e8f4ff",padding:"8px 10px",fontSize:12,fontFamily:"monospace",boxSizing:"border-box"}}/>
            </div>
          </div>
          <div style={{marginBottom:10}}>
            <div style={{fontSize:9,color:"#3a6e9a",marginBottom:4}}>ANALYSIS DATE</div>
            <div style={{display:"flex",gap:6,flexWrap:"wrap",alignItems:"center"}}>
              <input type="date" value={analysisDate} onChange={e=>setAnalysisDate(e.target.value)}
                style={{background:"#080e1a",border:"1px solid #1e3a5a",borderRadius:4,color:"#e8f4ff",padding:"6px 10px",fontSize:12,fontFamily:"monospace"}}/>
              {[[-7,"−7d"],[0,"TODAY"],[7,"+7d"],[30,"+30d"]].map(([days,label])=>(
                <button key={days} onClick={()=>{const d=new Date();d.setDate(d.getDate()+days);setAnalysisDate(d.toISOString().split("T")[0]);}}
                  style={{padding:"5px 8px",background:"#080e1a",border:"1px solid #1e3a5a",borderRadius:4,color:days===0?"#00e676":"#3a6e9a",fontSize:10,cursor:"pointer",fontFamily:"monospace"}}>{label}</button>
              ))}
            </div>
          </div>
          <div style={{display:"flex",gap:8}}>
            <button onClick={analyze} disabled={!dob}
              style={{flex:1,padding:"10px 0",background:"#00e67622",border:"1px solid #00e67655",borderRadius:6,color:"#00e676",fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"monospace"}}>
              🧬 READ ENERGY
            </button>
            <button onClick={savePerson} disabled={!dob}
              style={{padding:"10px 14px",background:"#38bdf822",border:"1px solid #38bdf855",borderRadius:6,color:"#38bdf8",fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"monospace"}}>
              💾 SAVE
            </button>
          </div>
        </div>
        ...
        {/* Saved people */}
        {saved.length>0&&(
          <div style={{background:"#0d1e30",border:"1px solid #1e3a5a",borderRadius:8,padding:"10px 14px",marginBottom:14}}>
            <div style={{fontSize:9,color:"#3a6e9a",letterSpacing:"0.1em",marginBottom:8}}>SAVED PROFILES</div>
            <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
              {saved.map(p=>(
                <div key={p.id} style={{display:"flex",alignItems:"center",gap:4,background:"#080e1a",border:"1px solid #1e3a5a",borderRadius:5,padding:"4px 8px"}}>
                  <button onClick={()=>{setName(p.name);setDob(p.dob);setTimeout(()=>{const r=calcHumanEnergy(p.dob,analysisDate);setResult({...r,name:p.name,dob:p.dob,analysisDate});},50);}}
                    style={{background:"none",border:"none",color:"#38bdf8",fontSize:11,cursor:"pointer",fontFamily:"monospace",fontWeight:700}}>{p.name}</button>
                  <span style={{color:"#3a6e9a",fontSize:10}}>{p.dob}</span>
                  <button onClick={()=>deletePerson(p.id)} style={{background:"none",border:"none",color:"#3a6e9a",cursor:"pointer",fontSize:10}}>✕</button>
                </div>
              ))}
            </div>
          </div>
        ...
        {result&&(
          <div>
            {/* Main verdict */}
            <div style={{background:"#0d1e30",border:`2px solid ${result.verdictColor}44`,borderRadius:10,padding:"18px 20px",marginBottom:12}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:10}}>
                <div>
                  <div style={{fontSize:10,color:"#3a6e9a",letterSpacing:"0.1em",marginBottom:3}}>
                    PLANETARY ENERGY · {result.analysisDate}
                    {result.analysisDate>todayStr&&<span style={{color:"#e040fb",marginLeft:8}}>🔮 FUTURE</span>}
                    {result.analysisDate<todayStr&&<span style={{color:"#38bdf8",marginLeft:8}}>📜 PAST</span>}
                  </div>
                  <div style={{fontSize:22,fontWeight:700,color:"#e8f4ff"}}>{result.name}</div>
                  <div style={{fontSize:10,color:"#3a6e9a",marginTop:2}}>Born: {result.dob} · {result.sunSign} Sun · {result.moonSign} Moon</div>
                </div>
                <div style={{textAlign:"right"}}>
                  <div style={{fontSize:32,fontWeight:700,color:result.verdictColor}}>{result.score.toFixed(1)}</div>
                  <div style={{fontSize:9,color:"#3a6e9a"}}>/ 10</div>
                </div>
              </div>
              <div style={{marginTop:12,background:result.verdictColor+"22",border:`1px solid ${result.verdictColor}44`,borderRadius:6,padding:"10px 14px",textAlign:"center"}}>
                <div style={{fontSize:18,fontWeight:700,color:result.verdictColor}}>{result.verdict}</div>
              </div>
              <div style={{marginTop:10,height:6,background:"#1e3a5a",borderRadius:3,position:"relative"}}>
                <div style={{position:"absolute",left:"50%",top:0,width:1,height:"100%",background:"#2a5a7a"}}/>
                <div style={{height:"100%",width:`${((result.score+10)/20)*100}%`,background:result.verdictColor,borderRadius:3,transition:"width 0.8s"}}/>
              </div>
              <div style={{display:"flex",justifyContent:"space-between",fontSize:8,color:"#3a6e9a",marginTop:2}}>
                <span>DIFFICULT -10</span><span>BALANCED 0</span><span>PEAK +10</span>
              </div>
            </div>

            {/* Trading advice */}
            <div style={{background:"#0d1e30",border:"1px solid #1e3a5a",borderRadius:8,padding:"12px 14px",marginBottom:12}}>
              <div style={{fontSize:9,color:"#3a6e9a",letterSpacing:"0.1em",marginBottom:6}}>TRADING ADVICE FOR {result.name.toUpperCase()}</div>
              <div style={{fontSize:13,color:"#e8f4ff",lineHeight:1.7}}>{result.tradingAdvice}</div>
            </div>

            {/* Timeline button */}
            <button onClick={()=>{if(showTimeline){setShowTimeline(false);}else{generateTimeline(result.dob);}}}
              ...
              {showTimeline?"▲ HIDE TIMELINE":"📅 SHOW 180-DAY ENERGY TIMELINE"}
            </button>
            ...
            {/* Energy domains */}
            <div style={{background:"#0d1e30",border:"1px solid #1e3a5a",borderRadius:8,padding:"12px 14px",marginBottom:12}}>
              <div style={{fontSize:9,color:"#3a6e9a",letterSpacing:"0.1em",marginBottom:12}}>ENERGY DOMAINS</div>
              {domainBar("💰 WEALTH & ABUNDANCE",result.domains.wealth,result.domains.wealth>=0?"#00e676":"#ff5252")}
              {domainBar("🎯 FOCUS & DISCIPLINE",result.domains.focus,result.domains.focus>=0?"#38bdf8":"#ff5252")}
              {domainBar("🍀 LUCK & OPPORTUNITY",result.domains.luck,result.domains.luck>=0?"#f59e0b":"#ff5252")}
              {domainBar("❤️ LOVE & RELATIONSHIPS",result.domains.love,result.domains.love>=0?"#e040fb":"#ff5252")}
              {domainBar("🌿 HEALTH & VITALITY",result.domains.health,result.domains.health>=0?"#00e676":"#ff5252")}
            </div>

            {/* Natal chart */}
            <div style={{background:"#0d1e30",border:"1px solid #1e3a5a",borderRadius:8,padding:"12px 14px",marginBottom:12}}>
              <div style={{fontSize:9,color:"#3a6e9a",letterSpacing:"0.1em",marginBottom:8}}>NATAL CHART · BIRTH PLANETS</div>
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(110px,1fr))",gap:6}}>
                {Object.entries(result.natal).map(([p,deg])=>(
                  <div key={p} style={{background:"#080e1a",border:"1px solid #1e3a5a",borderRadius:5,padding:"6px 8px"}}>
                    ...
                    <div style={{fontSize:10,fontWeight:700,color:"#e8f4ff"}}>{deg.toFixed(1)}°</div>
                    <div style={{fontSize:9,color:"#3a6e9a"}}>{signName(deg)}</div>
                    <div style={{fontSize:8,color:"#2a5a7a",marginTop:1}}>{PLANET_MEANING[p]}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Active aspects */}
            <div style={{background:"#0d1e30",border:"1px solid #1e3a5a",borderRadius:8,padding:"12px 14px"}}>
              <div style={{fontSize:9,color:"#3a6e9a",letterSpacing:"0.1em",marginBottom:10}}>ACTIVE TRANSITS (What the planets are doing to you NOW)</div>
              {result.aspects.map((a,i)=>{
                const isPos=a.score>=0;
                const c=isPos?"#00e676":a.nature==="tense"?"#ff5252":"#f59e0b";
                return(
                  <div key={i} style={{padding:"7px 0",borderBottom:"1px solid #0d2030"}}>
                    <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:3}}>
                      <div style={{width:5,height:5,borderRadius:"50%",background:c,flexShrink:0}}/>
                      <div style={{flex:1,fontSize:11}}>
                        <span style={{color:"#38bdf8",fontWeight:700}}>Transit {a.transit}</span>
                        <span style={{color:"#3a6e9a",margin:"0 4px"}}>in {a.tSign}</span>
                        <span style={{color:c,fontWeight:700}}>{a.aspect}</span>
                        <span style={{color:"#3a6e9a",margin:"0 4px"}}>natal</span>
                        <span style={{color:"#e8f4ff",fontWeight:700}}>{a.natal}</span>
                        <span style={{color:"#3a6e9a",margin:"0 4px"}}>in {a.nSign}</span>
                      </div>
                      <div style={{color:c,fontSize:11,fontWeight:700,flexShrink:0}}>{isPos?"+":""}{a.score.toFixed(2)}</div>
                    </div>
                    <div style={{fontSize:10,color:"#3a6e9a",paddingLeft:13}}>{ASPECT_MEANING[a.aspect]}</div>
                  </div>
                );
              })}
            </div>
...
#!/usr/bin/env python3
"""
ATM Machine App.js Patcher
Run from your src/ folder: python3 patch_appjs.py
"""
...
if not os.path.exists(INPUT):
    print("❌ App.js not found. Run this from your src/ folder.")
    sys.exit(1)
...
OLD1 = 'import { useState, useCallback, useEffect, useRef } from "react";'
NEW1 = '''import { useState, useCallback, useEffect, useRef } from "react";
import MoonCalendar from './MoonCalendar';
import MarketOracle from './MarketOracle';'''

if OLD1 not in src:
    print("❌ Change 1 marker not found - imports already added or file changed?")
else:
    src = src.replace(OLD1, NEW1, 1)
    print("✅ Change 1: Imports added")

# ── CHANGE 2: Add oracleDate state ────────────────────────────────────────────
OLD2 = '  const [chartSym,setChartSym]=useState("SPY");'
NEW2 = '''  const [chartSym,setChartSym]=useState("SPY");
...
if OLD2 not in src:
    ...
    print("✅ Change 2: oracleDate state added")

# ── CHANGE 3: Add tab buttons ─────────────────────────────────────────────────
OLD3 = '      {id:"human",   label:"🧬 HUMAN",    color:"#00e676"},\n    ],\n  ];'
NEW3 = '      {id:"human",   label:"🧬 HUMAN",    color:"#00e676"},\n      {id:"moon",    label:"🌙 MOON CAL", color:"#00b4d8"},\n      {id:"oracle",  label:"🔮 ORACLE",   color:"#e040fb"},\n    ],\n  ];'

if OLD3 not in src:
    print("❌ Change 3 marker not found")
else:
    src = src.replace(OLD3, NEW3, 1)
    print("✅ Change 3: Moon Cal + Oracle tab buttons added")

# ── CHANGE 4: Add tab panels ──────────────────────────────────────────────────
OLD4 = '          {activeTab==="human"&&<HumanEnergyReader/>}'
NEW4 = '''          {activeTab==="human"&&<HumanEnergyReader/>}
          {activeTab==="moon"&&(
...
if OLD4 not in src:
    print("❌ Change 4 marker not found")
else:
    src = src.replace(OLD4, NEW4, 1)
    print("✅ Change 4: Moon Cal + Oracle tab panels added")

# ── Write output ──────────────────────────────────────────────────────────────
with open(OUTPUT, "w", encoding="utf-8") as f:
    f.write(src)

print(f"\n🎉 Done! App.js patched successfully.")
print(f"📁 Backup at {BACKUP} if you need to roll back.")
print(f"\nNext: commit App.js to GitHub → Vercel auto-deploys in ~60s")
